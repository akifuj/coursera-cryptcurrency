...
public class TxHandler {
  ...
  /**
   * Creates a public ledger whose current UTXOPool (collection of unspent transaction outputs) is {@code utxoPool}. This should make a copy of utxoPool by using the UTXOPool(UTXOPool uPool) constructor.
   */
  ...
  public boolean isValidTx(Transaction tx) {
    ...
    for (int i = 0; i < tx.numInputs(); i++) {
      ...
      uniqueUtxo.addUTXO(urxo, output);
      previousTxOutSum += output.value
    }
    for (Transaction.Output out: tx.getTxOutputs()) {
